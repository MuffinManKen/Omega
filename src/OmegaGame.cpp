...
#undef BIND_STATUS
  ...
  // LevelTerrain — get_terrain_data() values in dungeon/city/interior levels
  BIND_ENUM_CONSTANT(TERRAIN_SPACE);
  BIND_ENUM_CONSTANT(TERRAIN_WALL);
  BIND_ENUM_CONSTANT(TERRAIN_PORTCULLIS);
  BIND_ENUM_CONSTANT(TERRAIN_OPEN_DOOR);
  BIND_ENUM_CONSTANT(TERRAIN_CLOSED_DOOR);
  BIND_ENUM_CONSTANT(TERRAIN_WHIRLWIND);
  BIND_ENUM_CONSTANT(TERRAIN_ABYSS);
  BIND_ENUM_CONSTANT(TERRAIN_VOID);
  BIND_ENUM_CONSTANT(TERRAIN_LAVA);
  BIND_ENUM_CONSTANT(TERRAIN_HEDGE);
  BIND_ENUM_CONSTANT(TERRAIN_WATER);
  BIND_ENUM_CONSTANT(TERRAIN_FIRE);
  BIND_ENUM_CONSTANT(TERRAIN_TRAP);
  BIND_ENUM_CONSTANT(TERRAIN_LIFT);
  BIND_ENUM_CONSTANT(TERRAIN_STAIRS_UP);
  BIND_ENUM_CONSTANT(TERRAIN_STAIRS_DOWN);
  BIND_ENUM_CONSTANT(TERRAIN_FLOOR);
  BIND_ENUM_CONSTANT(TERRAIN_STATUE);
  BIND_ENUM_CONSTANT(TERRAIN_RUBBLE);
  BIND_ENUM_CONSTANT(TERRAIN_ALTAR);
  BIND_ENUM_CONSTANT(TERRAIN_CHAIR);
  BIND_ENUM_CONSTANT(TERRAIN_SAFE);
  BIND_ENUM_CONSTANT(TERRAIN_FURNITURE);
  BIND_ENUM_CONSTANT(TERRAIN_BED);

  // CountryTerrain — get_terrain_data() values in the countryside
  BIND_ENUM_CONSTANT(COUNTRY_PLAINS);
  BIND_ENUM_CONSTANT(COUNTRY_TUNDRA);
  BIND_ENUM_CONSTANT(COUNTRY_ROAD);
  BIND_ENUM_CONSTANT(COUNTRY_MOUNTAINS);
  BIND_ENUM_CONSTANT(COUNTRY_PASS);
  BIND_ENUM_CONSTANT(COUNTRY_RIVER);
  BIND_ENUM_CONSTANT(COUNTRY_CITY);
  BIND_ENUM_CONSTANT(COUNTRY_VILLAGE);
  BIND_ENUM_CONSTANT(COUNTRY_FOREST);
  BIND_ENUM_CONSTANT(COUNTRY_JUNGLE);
  BIND_ENUM_CONSTANT(COUNTRY_SWAMP);
  BIND_ENUM_CONSTANT(COUNTRY_VOLCANO);
  BIND_ENUM_CONSTANT(COUNTRY_CASTLE);
  BIND_ENUM_CONSTANT(COUNTRY_TEMPLE);
  BIND_ENUM_CONSTANT(COUNTRY_CAVES);
  BIND_ENUM_CONSTANT(COUNTRY_DESERT);
  BIND_ENUM_CONSTANT(COUNTRY_CHAOS_SEA);
  BIND_ENUM_CONSTANT(COUNTRY_STARPEAK);
  BIND_ENUM_CONSTANT(COUNTRY_DRAGONLAIR);
  BIND_ENUM_CONSTANT(COUNTRY_MAGIC_ISLE);

  // ItemGlyph — get_item_data() values
  BIND_ENUM_CONSTANT(ITEM_CORPSE);
  BIND_ENUM_CONSTANT(ITEM_CASH);
  BIND_ENUM_CONSTANT(ITEM_PILE);
  BIND_ENUM_CONSTANT(ITEM_FOOD);
  BIND_ENUM_CONSTANT(ITEM_WEAPON);
  BIND_ENUM_CONSTANT(ITEM_MISSILE_WEAPON);
  BIND_ENUM_CONSTANT(ITEM_SCROLL);
  BIND_ENUM_CONSTANT(ITEM_POTION);
  BIND_ENUM_CONSTANT(ITEM_ARMOR);
  BIND_ENUM_CONSTANT(ITEM_SHIELD);
  BIND_ENUM_CONSTANT(ITEM_CLOAK);
  BIND_ENUM_CONSTANT(ITEM_BOOTS);
  BIND_ENUM_CONSTANT(ITEM_STICK);
  BIND_ENUM_CONSTANT(ITEM_RING);
  BIND_ENUM_CONSTANT(ITEM_THING);
  BIND_ENUM_CONSTANT(ITEM_ARTIFACT);
}
